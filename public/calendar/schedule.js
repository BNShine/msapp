...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    async function handleSaveAppointment() {
        // A lógica principal de salvar está em manageShowed.js, mas disparamos um evento para garantir a atualização
    ...
    function renderAppointments() {
        ...
        appointmentsToRender.forEach(appt => {
            ...
            let textColor = 'text-white'; // Cor de texto padrão
            ...
            if (appt.verification === 'Canceled') {
                ...
                textColor = 'text-black'; // Cor de texto preta para fundo amarelo
            }
